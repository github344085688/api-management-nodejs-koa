...
export default class Pager extends WiseVue {
    ...
    loadNextPage() {
        this.changeActivePage(this.pager.activedPage + 1 > this.totalPage ? this.pager.totalPage : this.pager.activedPage + 1);
    }
    ...
    goToPage() {
        this.changeActivePage(this.inputPage > this.pager.totalPage ? this.pager.totalPage : this.inputPage);
    }
